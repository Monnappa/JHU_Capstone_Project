...
tabPanel("About", tags$div(HTML("
                                ...
                                <h4> Monnappa Somanna </h4>
                                <h5> Github Link : <a href=https://github.com/Monnappa/JHU_Capstone_Project> Codes </a> </h5>
                                <h5> Slide Deck Link : <a href=http://rpubs.com/Monnapppa/237234> Codes </a></h5></center>
                                <br>
